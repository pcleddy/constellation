...
- click stars to set an orbit target and open info panels with distance, spectral type, and lore
...
- click star: set that star as the orbit target and open star info
- double-click star: recenter on that star
